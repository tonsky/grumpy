...
(def debug-posts
  [["New"                {}]
   ...
   ["Draging with image" {:id "0THGrh25y" :media/dragging? true :picture {:url "M0C_mT1.orig.png" :dimensions [750 265]}}]
   ["Draging over image" {:id "0THGrh25y" :media/dragging? true :media/dragover? true :picture {:url "M0C_mT1.orig.png" :dimensions [750 265]}}]
   ["Draging tall blob"  {:media/dragging? true :media/object-url "/post/0T6kDVGD2/LycvDQV.orig.jpeg" :media/dimensions [591 1280]}]
   ["Uploading 0%"       {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/dimensions [750 265] :media/status :media.status/uploading :media/upload-progress 0}]
   ["Uploading 50%"      {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/dimensions [750 265] :media/status :media.status/uploading :media/upload-progress 0.5}]
   ["Uploading tall 30%" {:media/object-url "/post/0T6kDVGD2/LycvDQV.orig.jpeg" :media/dimensions [591 1280] :media/status :media.status/uploading :media/upload-progress 0.3}]
   ["Upload failed"      {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/dimensions [750 265] :media/status :media.status/upload-failed :media/failed-message "Upload failed with 500 Internal Server Error"}]
   ["Upload failed long" {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/dimensions [750 265] :media/status :media.status/upload-failed :media/failed-message "Upload failed with 500 Internal Server Error Machine says no No way Nope NaN NaN NaN"}]
   ["Upload failed tall" {:media/object-url "/post/0T6kDVGD2/LycvDQV.orig.jpeg" :media/dimensions [591 1280] :media/status :media.status/upload-failed :media/failed-message "Upload failed with 500 Internal Server Error"}]
   ...
   ["Delete failed"      {:media/status :media.status/delete-failed :media/failed-message "Delete failed with 500 Internal Server Error" :id "0THGrh25y" :picture {:url "M0C_mT1.fit.jpeg", :content-type "image/jpeg", :dimensions [750 265]}}]
])
