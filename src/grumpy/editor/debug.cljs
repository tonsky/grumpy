...
(def debug-posts
  [["New"                {}]
   ...
   ["Body failed"        {:body "Hello, world!" :body/edited "Hello, world! (edited)" :body/status :body.status/failed :body.status/message "Autosave failed"}]
   ["Dragging"           {:media/dragging? true}]
   ["Dragging over"      {:media/dragging? true :media/dragover? true}]
   ["Draging with image" {:media/dragging? true :picture {:url "/post/0THGrh25y/M0C_mT1.orig.png"}}]
   ["Draging over image" {:media/dragging? true :media/dragover? true :picture {:url "/post/0THGrh25y/M0C_mT1.orig.png"}}]
   ["Draging tall blob"  {:media/dragging? true :media/object-url "/post/0T6kDVGD2/LycvDQV.orig.jpeg"}]
   ["Uploading 0%"       {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/status :media.status/uploading :media.status/progress 0}]
   ["Uploading 50%"      {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/status :media.status/uploading :media.status/progress 0.5}]
   ["Uploading tall 30%" {:media/object-url "/post/0T6kDVGD2/LycvDQV.orig.jpeg" :media/status :media.status/uploading :media.status/progress 0.3}]
   ["Upload failed"      {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/status :media.status/failed :media.status/message "500 Internal Server Error"}]
   ["Upload failed long" {:media/object-url "/post/0THGrh25y/M0C_mT1.orig.png" :media/status :media.status/failed :media.status/message "500 Internal Server Error Machine says no No way Nope NaN NaN NaN"}]
   ["Uploaded"           {:picture {:url "/post/0THGrh25y/M0C_mT1.fit.jpeg", :content-type "image/jpeg", :dimensions [750 265]}}]
   ["Uploaded vertical"  {:picture {:url "/post/0TDdxMGm8/M-Jw_2o.fit.jpeg", :content-type "image/jpeg", :dimensions [638 922]}}]
])
